...
b6 = "          ║═╝     ╚═╝ ╚═════╝ ╚═══║══╝╚═╝   ╚═╝       ╚═╝    ║═════╝  ╚═════╝ ╚══════╝╚══════╝"
b7 = "          ║                       ║                          ║"
b8 = "          ║═════(1) Send Text     ║═════(4) Change           ╚═════(7) Exit"
b9 = "          ║                       ║                          "
...
while True:
    ...
    if main_input == "5":
        ...
        banner()
    if main_input == "6":
        print("1 is Send Message. 2 is SPAM Message. 3 is Change Url Webhook (Link). 4 is Change Name Bot. 5 is SPAM Message Our Discord and Flood. 6 is Info Multi Tools")
        restart()
        banner()
    if main_input == "7":
        quit()
